...
const ThankYouPage = async ({ searchParams }: PageProps) => {
  ...
  return (
    <main className="relative lg:min-h-full">
      <div className="hidden sm:block h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2">
        <Image
          fill
      ...
      <div>
        <div className="mx-auto max-w-2xl px-4 py-15 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
